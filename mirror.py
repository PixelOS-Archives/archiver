...
def main():
    ...
    # 20 workers for downloading explicitly
    # 20 workers for processing/uploading
    
    with ThreadPoolExecutor(max_workers=20) as download_pool, ThreadPoolExecutor(max_workers=20) as upload_pool:
